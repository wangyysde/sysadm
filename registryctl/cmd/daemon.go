...
var daemonCmd = &cobra.Command{
    Use: "daemon",
    Short: "start restart stop or reload the daemon of registryctl",
	Args: cobra.NoArgs,
}
...
var restartCmd = &cobra.Command{
	Use: "restart",
	Short: "Restart the daemon of reistryctl server",
	Run: func(cmd *cobra.Command, args []string){},
	Args: cobra.NoArgs,
}
...
var stopCmd = &cobra.Command{
	Use: "stop",
	Short: "Stop the daemon of registryctl server",
	Run: func(cmd *cobra.Command, args []string){},
	Args: cobra.NoArgs,
}
...
var reloadCmd = &cobra.Command{
	Use: "reload",
	Short: "Reload the daemon of registryctl server",
	Run: func(cmd *cobra.Command, args []string){},
	Args: cobra.NoArgs,
}
