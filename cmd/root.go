...
var rootCmd = &cobra.Command{
	Use:   "sysadm",
	Short: "sysadm： An easily system administration platform",
	Long:  dedent.Dedent(`
...
func init() {
	...
	rootCmd.PersistentFlags().StringVar(&cfgFile, "config", "", "config file (default is PROG_ROOT/conf/config.yaml)")
