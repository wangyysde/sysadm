...
type Command struct {
	...
	gin.H
	TFunc TestFunc //func(Para string, Age int) error
	// 定义的命令ID值
	...
	unExportFeild string
}

type TestFunc func(Para string, Age int) error

var UserMap = make(map[string]string)

func ForSignature(Para string, Age int) error {
	fmt.Printf("aaa: %s\n Age: %d\n", Para, Age)
	return nil
}

func (c Command) ThisIsAMethod(Para string, Age int) error {
	fmt.Printf("aaa: %s\n Age: %d\n", Para, Age)
	return nil
}
