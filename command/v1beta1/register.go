...
var allowedVerbs runtime.VerbKind = runtime.Create | runtime.Get | runtime.List | runtime.Delete | runtime.Update | runtime.Watch
...
func init() {
	runtime.Register(SchemaGroupVersion, TypeRegistryFunc, conversionRegistryFunc)
	return
}
