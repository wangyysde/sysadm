...
function all_info(){
	...
	echo "#   BUILD_IMAGE: whether build new image using the binary package just built."
	echo "#      y, build image, otherwise not build image"
	echo "#	  IMAGEVER: specifying the tag string of the new image which will be build if BUILD_IMAGE is y"  
	echo "#"
	echo "# Example:"
	echo "#   make"
	echo "#   make all"
